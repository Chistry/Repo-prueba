...
def mostrarProductos():
  for product in Electrodomestrico.electrodomestricos:
    product.mostrar()
...
def main():
    while True:
        ...
        print('Washers: ')
        lavadora1= Lavadora(producto.get('washer')[0].get('cod_p'), producto.get('washer')[0].get('price'), producto.get('washer')[0].get('brand'),producto.get('washer')[0].get('color'), producto.get('washer')[0].get('capacity'))
        lavadora2= Lavadora(producto.get('washer')[1].get('cod_p'), producto.get('washer')[1].get('price'), producto.get('washer')[1].get('brand'),producto.get('washer')[1].get('color'), producto.get('washer')[1].get('capacity'))
        print('Washer 1\n',lavadora1, '\n\nWasher 2\n', lavadora2)
        

        #Lavadora(producto.get('washer')[0].get('price')), Lavadora(producto.get('washer')[0].get('brand')), Lavadora(producto.get('washer')[0].get('color')), Lavadora(producto.get('washer')[0].get('capacity')))
        break
    #(self, codigo, precio, marca, color, capacidad)
    #Product.productos.append(Flower(product["id"], product["name"], product["stock"], colors))
